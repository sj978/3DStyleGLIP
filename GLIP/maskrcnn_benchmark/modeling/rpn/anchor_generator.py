...
class AnchorGenerator(nn.Module):
    ...
    def __init__(
        ...
        """
        :param sizes: (64, 128, 256, 512, 1024)
        :param aspect_ratios: (1.0,)
        :param anchor_strides: (8, 16, 32, 64, 128)
        :param straddle_thresh: 0
        """
    ...
    def grid_anchors(self, grid_sizes):
        ...
        for size, stride, base_anchors in zip(
            ...
            # arange(0, 40 * 8, step=8) / (0, 20 * 16, step=16) / (0, 10 * 32, step=32)
    ...
    def forward(self, images, feature_maps):  # image_list -> images
        # images: [1, 3, 320, 320] tensor
        # feature_maps: [1, 256, w, h] tensor (w, h = 40, 20, 10, 5, 3)
        grid_sizes = [feature_map.shape[-2:] for feature_map in feature_maps]
        # grid_sizes = [w, h] tensor
        # anchor_per_grid = (40, 40), w, h: 64 / (20, 20), w, h: 128 / (10, 10), w, h: 256 / (5, 5), w, h: 512 / (3, 3), w, h: 1024
        # anchors_over_all_feature_maps = [[40x40 numbers of anchors], [20x20 anchors], [10x10 anchors], [5x5 anchors], [3x3 anchors]]
        ...
        # if isinstance(image_list, ImageList):   # use
